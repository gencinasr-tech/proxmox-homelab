...
Plataforma de gestión de fotos y videos auto-hospedada.
...
Immich proporciona:
- 📸 Backup automático de fotos desde móvil
- 🎥 Gestión de videos
- 🔍 Búsqueda por contenido (ML)
- 👥 Compartir álbumes
...
- [SSO Immich](../09-authentication/sso-immich.md)
